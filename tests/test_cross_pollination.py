...
class TestCrossPollination(unittest.TestCase):
    def test_empty_returns_no_pollination(self):
    ...
    def test_all_one_cluster_no_pollination(self):
        clusters = ((0, 1, 2),)
        responses = ["a", "b", "c"]
    ...
    def test_split_clusters_pollinate_non_top(self):
        clusters = ((0, 1), (2,))
    ...
    def test_top_cluster_not_modified(self):
        clusters = ((0, 1), (2,))
        responses = ["top1", "top2", "other"]
    ...
    def test_pollinated_count_matches_non_top(self):
        clusters = ((0,), (1,), (2,))
        responses = ["a", "b", "c"]
    ...
    def test_multiple_non_top_clusters(self):
        clusters = ((0, 1), (2,), (3,))
        responses = ["a", "b", "c", "d"]
        calls: list[str] = []
