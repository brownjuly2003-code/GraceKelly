...
class TestHacCluster(unittest.TestCase):
    ...
    def test_two_orthogonal_no_merge(self):
        sim = [[1.0, 0.0], [0.0, 1.0]]
        result = hac_cluster(sim, threshold=0.85)
        self.assertEqual(result.num_clusters, 2)

    def test_three_items_two_similar(self):
        sim = [
            [1.0, 0.95, 0.1],
            [0.95, 1.0, 0.1],
            [0.1, 0.1, 1.0],
    ...
    def test_threshold_zero_all_merge(self):
        sim = [
            [1.0, 0.5, 0.3],
            [0.5, 1.0, 0.4],
            [0.3, 0.4, 1.0],
    ...
    def test_threshold_one_no_merge(self):
        sim = [
            [1.0, 0.99, 0.5],
            [0.99, 1.0, 0.5],
            [0.5, 0.5, 1.0],
    ...
    def test_result_is_frozen(self):
        ...
        with self.assertRaises(AttributeError):
            result.num_clusters = 5

    def test_avg_linkage(self):
