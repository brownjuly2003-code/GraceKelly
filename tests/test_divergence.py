...
class TestDivergence(unittest.TestCase):
    def test_high_score_accept(self) -> None:
    ...
    def test_result_is_frozen(self) -> None:
        ...
        with self.assertRaises(AttributeError):
            setattr(result, "action", DivergenceAction.ESCALATE)

    def test_expand_extra_rounds_correct(self) -> None:
