...
class TestClusterConfidence(unittest.TestCase):
    ...
    def test_all_one_cluster(self) -> None:
        clusters = ((0, 1, 2),)
        sim = [
            [1.0, 0.9, 0.95],
            [0.9, 1.0, 0.92],
    ...
    def test_three_clusters_top_ratio(self) -> None:
        clusters = ((0, 1, 2), (3,), (4,))
    ...
    def test_zero_intra_similarity(self) -> None:
        clusters = ((0, 1),)
        sim = [[1.0, 0.0], [0.0, 1.0]]
        result = compute_cluster_confidence(clusters, sim)
    ...
    def test_confidence_equals_ratio_times_intra(self) -> None:
        clusters = ((0, 1), (2,))
        sim = [
            [1.0, 0.8, 0.1],
            [0.8, 1.0, 0.1],
